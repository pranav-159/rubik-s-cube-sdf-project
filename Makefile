...
$(SRC) : $(SRC).cpp set_buffer.o data.o shaders.o window.o options.o glad.o  opengl.h 
	g++ -o $(SRC) $(SRC).cpp set_buffer.o data.o shaders.o window.o options.o glad.o $(LIB_FLAGS)
...
clean : 
	rm $(SRC) set_buffer.o data.o shaders.o window.o options.o glad.o
