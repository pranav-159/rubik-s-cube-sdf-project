...
//front face green color {{{
    ...
    - cubeSize/6-2*gap/3,     - cubeSize/2,       cubeSize/2,   1.0f, 0.0f, 1.0f,
    - cubeSize/6-2*gap/3,     - cubeSize/2,   cubeSize/6+2*gap/3,   1.0f, 0.0f, 1.0f,
        - cubeSize/2,     - cubeSize/2,   cubeSize/6+2*gap/3,   1.0f, 0.0f, 1.0f,

    - cubeSize/6+gap/3,     - cubeSize/2,       cubeSize/2,   1.0f, 0.0f, 1.0f,
      cubeSize/6-gap/3,     - cubeSize/2,       cubeSize/2,   1.0f, 0.0f, 1.0f,
      cubeSize/6-gap/3,     - cubeSize/2,   cubeSize/6+2*gap/3,   1.0f, 0.0f, 1.0f,
    - cubeSize/6+gap/3,     - cubeSize/2,   cubeSize/6+2*gap/3,   1.0f, 0.0f, 1.0f,
      ...
      cubeSize/6+2*gap/3,     - cubeSize/2,   cubeSize/6+2*gap/3,   1.0f, 0.0f, 1.0f,
        ...
        - cubeSize/2,     - cubeSize/2,   cubeSize/6-gap/3,   1.0f, 0.0f, 1.0f,
    - cubeSize/6-2*gap/3,     - cubeSize/2,   cubeSize/6-gap/3,   1.0f, 0.0f, 1.0f,
    - cubeSize/6-2*gap/3,     - cubeSize/2, - cubeSize/6+gap/3,   1.0f, 0.0f, 1.0f,
        - cubeSize/2,     - cubeSize/2, - cubeSize/6+gap/3,   1.0f, 0.0f, 1.0f,

    - cubeSize/6+gap/3,     - cubeSize/2,   cubeSize/6-gap/3,   1.0f, 0.0f, 1.0f,
      cubeSize/6-gap/3,     - cubeSize/2,   cubeSize/6-gap/3,   1.0f, 0.0f, 1.0f,
      cubeSize/6-gap/3,     - cubeSize/2, - cubeSize/6+gap/3,   1.0f, 0.0f, 1.0f,
    - cubeSize/6+gap/3,     - cubeSize/2, - cubeSize/6+gap/3,   1.0f, 0.0f, 1.0f,
